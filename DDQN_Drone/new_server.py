...
parser.add_argument('--model', '-m', default='2020-01-22/16_300000', type=str,
                    help='model')
...
class StatusHandler(tornado.websocket.WebSocketHandler):
    ...
    def received_message(self, m):
        ...
        observation = {"image": image, "depth":depth, "ir":ir, "ground":ground, "compass":compass, "target":target, 'gyro':gyro}
